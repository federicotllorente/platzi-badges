    ...
    return (
        <div className="BadgeNew">
            ...
            <div className="BadgeNew__container">
                ...
                />
                <BadgeForm onSubmit={props.handleSubmit} onChange={props.handleChange} formValues={props.form} action="edit" />
            </div>
            {props.error && (
